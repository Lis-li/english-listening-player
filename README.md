...
![听写练习流程：隐藏原文、输入听到的内容、查看逐词对比](docs/images/dictation-workflow.png)
...
![Dictation workflow: hide the transcript, type what you hear, and review a word-by-word comparison](docs/images/dictation-workflow.png)
