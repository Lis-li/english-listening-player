...
下载或克隆仓库并启动本地服务器后，文章资料库会直接显示以下三篇原创材料，并可立即播放美式女声的整篇及逐句音频：

- *Fictional Report: Solar Clinics Restore Health Services After Coastal Storm*
- *Fictional Report: Car Factory Tests Humanoid Robots on Overnight Shift*
- *Fictional Report: New Laptop Chip Runs AI Tools Without Cloud Connection*

这些内容均为本项目原创的**虚构新闻听力训练报道**。其中的地点、机构、公司、人物和事件不代表真实新闻。切换到其他声部时，需要联网生成相应音频。
...
### Bundled local listening materials

After downloading or cloning the repository and starting the local server, the article library immediately includes three original reports with ready-to-play American female full-article and sentence audio:

- *Fictional Report: Solar Clinics Restore Health Services After Coastal Storm*
- *Fictional Report: Car Factory Tests Humanoid Robots on Overnight Shift*
- *Fictional Report: New Laptop Chip Runs AI Tools Without Cloud Connection*

All three are **original fictional news-style reports created for listening practice**. Their places, organisations, companies, people, and events are not real news. Switching to another voice requires an internet connection to generate that audio.
